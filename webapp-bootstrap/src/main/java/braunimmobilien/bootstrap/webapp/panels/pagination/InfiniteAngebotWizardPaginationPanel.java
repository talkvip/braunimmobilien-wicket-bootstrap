 ...
 */
public class InfiniteAngebotWizardPaginationPanel extends AbstractGeneralAngebotWizardPaginationPanel {
     ...
     */
    public InfiniteAngebotWizardPaginationPanel(final String markupId) {
        super(markupId);
