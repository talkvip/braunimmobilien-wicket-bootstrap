 ...
 */
public class WizardBootstrapPage extends BasePage
{
	/**
	 * Construct.
	 * 
	 ...
	 */
	public <C extends Wizard> WizardBootstrapPage()
	{	
		try
		{
			Constructor<? extends Wizard> ctor = NewLandWizard.class.getConstructor(String.class,Class.class,PageParameters.class);
			Wizard wizard = ctor.newInstance("wizard",braunimmobilien.bootstrap.webapp.pages.BraunHomePage.class,new PageParameters());
			add(wizard);
	...
	public <C extends Wizard> WizardBootstrapPage(Class<C> wizardClass)
	{	
		if (wizardClass == null)
		{
	...
	public <C extends Wizard> WizardBootstrapPage(Class<C> wizardClass,Class responsepage,PageParameters pageparameters)
	{
		if (wizardClass == null)
		{
			throw new IllegalArgumentException("argument wizardClass must be not null");
