...
public class EinstellungenTest{
    ...
    static Logger logger = LoggerFactory.getLogger(EinstellungenTest.class);
    ...
    public void searchObjektandStore(){
       	tester.executeUrl("../../wicket/bookmarkable/braunimmobilien.bootstrap.webapp.pages.einstellungen.EinstellungenPage");	
       	tester.assertRenderedPage(EinstellungenPage.class);
    }
