...
public class Spring3YahpOld {
	...
	private static final Log LOG = LogFactory.getLog(Spring3YahpOld.class);
...
LOG.info("Anzahl  Tokens :"+i);
	 ...
	 private static Credential authorize() throws Exception {
		    ...
		    GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY,
		        new InputStreamReader(Spring3YahpOld.class.getResourceAsStream("/calendarclient_secret.json")));
