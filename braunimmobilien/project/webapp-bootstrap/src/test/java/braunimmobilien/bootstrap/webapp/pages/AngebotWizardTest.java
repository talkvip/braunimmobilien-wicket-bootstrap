...
import braunimmobilien.bootstrap.webapp.pages.angebot.AngebotWizardListPage;
...
public class AngebotWizardTest{
    private WicketTester tester;
    static Logger logger = LoggerFactory.getLogger(AngebotWizardTest.class);
    ...
    public void searchObjektandStore(){
       	tester.executeUrl("../../wicket/bookmarkable/braunimmobilien.bootstrap.webapp.pages.angebot.AngebotWizardListPage");	
        tester.assertRenderedPage(AngebotWizardListPage.class);
    }
