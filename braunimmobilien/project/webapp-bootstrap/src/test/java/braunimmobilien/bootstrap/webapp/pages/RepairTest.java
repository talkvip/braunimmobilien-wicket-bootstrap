...
public class RepairTest{
    ...
    static Logger logger = LoggerFactory.getLogger(RepairTest.class);
    ...
    public void searchObjektandStore(){
       	tester.executeUrl("../../wicket/bookmarkable/braunimmobilien.bootstrap.webapp.pages.repair.Repair");	
       	tester.assertRenderedPage(Repair.class);
    }
