...
public class ParameterTest{
    ...
    static Logger logger = LoggerFactory.getLogger(ParameterTest.class);
    ...
    public void searchObjektandStore(){
       	tester.executeUrl("../../wicket/bookmarkable/braunimmobilien.bootstrap.webapp.pages.parameters.Parameters");	
