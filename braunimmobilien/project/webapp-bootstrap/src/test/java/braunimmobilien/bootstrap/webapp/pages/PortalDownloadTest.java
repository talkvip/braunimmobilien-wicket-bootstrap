...
import braunimmobilien.bootstrap.webapp.pages.parameters.Parameters;
...
import braunimmobilien.bootstrap.webapp.pages.PortalDownloadPage;
...
public class PortalDownloadTest{
    ...
    static Logger logger = LoggerFactory.getLogger(PortalDownloadTest.class);
    ...
    public void searchObjektandStore(){
       	tester.executeUrl("../../wicket/bookmarkable/braunimmobilien.bootstrap.webapp.pages.PortalDownloadPage");	
     	tester.assertRenderedPage(PortalDownloadPage.class);
    }
