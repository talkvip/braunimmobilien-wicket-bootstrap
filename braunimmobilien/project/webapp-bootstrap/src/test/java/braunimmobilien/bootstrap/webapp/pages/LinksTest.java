...
import braunimmobilien.bootstrap.webapp.pages.subjects.SubjectsPage;
...
public class LinksTest{
    ...
    static Logger logger = LoggerFactory.getLogger(LinksTest.class);
    ...
    public void searchObjektandStore(){
       	tester.executeUrl("../../wicket/bookmarkable/braunimmobilien.bootstrap.webapp.pages.subjects.SubjectsPage");	
       	tester.assertRenderedPage(SubjectsPage.class);
    }
