 ...
 * @author miha
 */
public abstract class WithoutBasePage extends GenericWebPage<Void> {
     ...
     */
    public WithoutBasePage(final PageParameters parameters) {
       super(parameters);
        ...
        return new NavbarDropDownButton(Model.of("Boostrap Braunimmobilien")) {
            ...
            protected List<AbstractLink> newSubMenuButtons(String buttonMarkupId) {
                final List<AbstractLink> subMenu = new ArrayList<AbstractLink>();
                  ...
                  subMenu.add(new MenuBookmarkablePageLink<Void>(braunimmobilien.bootstrap.webapp.pages.angebot.AngebotBreadcrumbPage.class, Model.of("Angebotsliste")).setIconType(GlyphIconType.downloadalt));
                  subMenu.add(new MenuBookmarkablePageLink<Void>(braunimmobilien.bootstrap.webapp.pages.wizard.IndexBootstrap.class, Model.of("Strassensuch")).setIconType(GlyphIconType.downloadalt));
                  subMenu.add(new MenuBookmarkablePageLink<Void>(braunimmobilien.bootstrap.webapp.pages.breadcrumb.IndexBootstrap.class, Model.of("StrassensuchBreadcrumb")).setIconType(GlyphIconType.downloadalt));
                         //     subMenu.add(new MenuBookmarkablePageLink<Void>(DatetimePickerPage.class, Model.of("DateTimePicker")).setIconType(GlyphIconType.time));
                              /*     subMenu.add(new MenuBookmarkablePageLink<Void>(SelectPage.class, Model.of("SelectPicker")).setIconType(GlyphIconType.search));
                subMenu.add(new MenuBookmarkablePageLink<Void>(IssuesPage.class, Model.of("Github Issues")).setIconType(GlyphIconType.book));
                subMenu.add(new MenuBookmarkablePageLink<Void>(ExtensionsPage.class, Model.of("Extensions")).setIconType(GlyphIconType.alignjustify));
...
//        response.render(CssHeaderItem.forReference(FixBootstrapStylesCssResourceReference.INSTANCE));
        ...
        response.render(JavaScriptHeaderItem.forReference(new PackageResourceReference(WithoutBasePage.class,"bootstrap-treeview.js")));
        response.render(CssHeaderItem.forReference(new CssResourceReference(WithoutBasePage.class, "bootstrap-treeview.css")));
        response.render(JavaScriptHeaderItem.forReference(new PackageResourceReference(WithoutBasePage.class,"treeview.js")));
