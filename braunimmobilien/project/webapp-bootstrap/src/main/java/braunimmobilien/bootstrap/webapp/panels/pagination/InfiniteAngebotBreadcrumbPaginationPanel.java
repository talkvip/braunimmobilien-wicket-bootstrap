 ...
 */
public class InfiniteAngebotBreadcrumbPaginationPanel extends AbstractGeneralAngebotBreadcrumbPaginationPanel {
     ...
     */
    public InfiniteAngebotBreadcrumbPaginationPanel(final String markupId) {
        super(markupId);
    ...
    protected List<Angebot> createData() {
        List<Angebot> elements = new ArrayList<Angebot>(1000);
        for (int i = 0, l = 1000; i < l; ++i) {
            elements.add(new Angebot());
        }
        return elements;
    }
