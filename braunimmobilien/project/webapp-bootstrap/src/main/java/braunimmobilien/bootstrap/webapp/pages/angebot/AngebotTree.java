...
private void showPerson(Objperszuord objperszuord,PageParameters pageparameters,MyFoo myfoo){
	...
	fooAAB =new MyFoo(myfoo, objperszuord.getEigentuemertyp().getTypenbeschreibung()+" "+objperszuord.getPersonen().getEigtName(),new IndexBootstrap(AngebotTree.class,pageparameters,new EntityModel<Personen>(objperszuord.getPersonen()),false));
