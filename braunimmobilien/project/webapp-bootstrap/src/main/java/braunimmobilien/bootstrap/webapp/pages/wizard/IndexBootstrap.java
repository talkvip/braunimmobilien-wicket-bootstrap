...
PageParameters pageparameters;
	...
	private static final class WizardLink extends Link
	{
		...
		public void onClick()
		{this.
			setResponsePage(new WizardBootstrapPage(wizardClass));
		}
	}

	private static final class IndexLink extends Link
	{	public IndexLink(String id)
		{
		super(id);
	...
	//	add(new WizardLink("staticWizardWithPanelsLink", StaticWizardWithPanels.class));
		add(new WizardLink("newLandWizardLink", NewLandWizard.class));
		   Form<Void> form = new Form<Void>("ConvertForm") {
	             ...
	             {setResponsePage(IndexBootstrap.class);
	...
	//	add(new WizardLink("staticWizardWithPanelsLink", StaticWizardWithPanels.class));
		add(new WizardLink("newLandWizardLink", NewLandWizard.class));
		add(new IndexLink("direktLandWizardLink"));
		   Form<Void> form = new Form<Void>("ConvertForm") {
	             @Override
	             protected void onComponentTag(ComponentTag tag) {
	                 super.onComponentTag(tag);
