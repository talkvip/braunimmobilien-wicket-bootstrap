 ...
 */
public class ErrorHandlingTest extends CocoonHtmlUnitTestCase {
    ...
    public void testPerSitemap404() throws Exception {
        ...
        assertTrue(this.response.getContentAsString()
                .indexOf("404 Resource Not Available (Cocoon 3 Integration Tests)") > 0);
    }
    ...
    public void testPerSitemapCustomError() throws Exception {
        ...
        assertTrue(this.response.getContentAsString().indexOf("Error 500 (Cocoon 3 Integration Tests)") > 0);
    }
    ...
    public void testPerPipelineCustomError() throws Exception {
        ...
        assertTrue(this.response.getContentAsString().indexOf("Error 501 (Cocoon 3 Integration Tests)") > 0);
    }
}
